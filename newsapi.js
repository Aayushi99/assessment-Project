...
$(document).ready(function(){
    ...
    $("#searchbtn").on("click",function(e){
      ...
      // https://newsapi.org/v2/top-headlines?country=in&category=technology&apiKey=68764c5145b14b1f8296ffcae6be889b
      let url = "https://newsapi.org/v2/top-headlines?q="+query+"&country=in&category=technology&apiKey=68764c5145b14b1f8296ffcae6be889b";
      ...
      if(query !== ""){
        ...
        $.ajax({
          ...
          error: function(){
             ...
             <img src="img/internet.png" style="margin-top:17px;" width="270px" height="270px" class="responsive-img">
             </div>`;
